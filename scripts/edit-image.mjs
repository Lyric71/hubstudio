#!/usr/bin/env node
// WaveSpeed image-edit CLI. Feed it one or more existing pictures plus a prompt,
// poll for the result, save the edited file. This is the image-to-image sibling
// of generate-image.mjs: same submit + poll flow, same WaveSpeed account/key,
// but it sends your input image(s) to the model's /edit endpoint.
//
// Usage:
